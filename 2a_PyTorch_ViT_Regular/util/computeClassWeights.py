...
def computeClassWeights(dataset1_sizes, dataset2_sizes,
    ...
    if os.path.isfile(fileNameSaveWeights):
        ...
        classCountAll1 = getClassCount1(classVec['train']) + getClassCount1(classVec['val'])
        # if no count, put 1
        numSub = 10
        ...
        classCountAll2 = getClassCount2(dataloader2_train) + getClassCount2(dataloader2_val)
        # if no count, put 1
        numSub = 10
