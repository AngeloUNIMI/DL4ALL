    ...
    for epoch in range(num_epochs):
        ...
        # for batch_num, (inputs1, dummyTargets, filename, label1) in enumerate(dataloaders1_chosen):
            ...
            with torch.set_grad_enabled(True):
                ...
                loss1 = 0.5 * loss1  # weight loss by 0.5
                loss1.backward()
                optimizer.step()
            ...
            with torch.set_grad_enabled(True):
                ...
                if loss2 < best_loss:
                    ...
                    # weight loss
                    loss2 = 0.5 * loss2  # weight loss by 0.5
                    ...
                    # otherwise, load state before loss1
                    model.load_state_dict(model_wts)
                    optimizer.load_state_dict(optimizer_wts)
